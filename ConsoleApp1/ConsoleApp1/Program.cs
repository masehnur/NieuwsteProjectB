...
namespace Aantal_Bezoekers
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Er moet voor minimaal één persoon worden gereserveerd.");
            }
            else  // meer dan 8 personen
            {
                Console.WriteLine("Als u voor meer dan 8 personen wilt boeken, neem dan telefonisch contact met ons op.\nT: 01 7245 754");
            }
        }
